...
INSERT INTO  `dailymatons_simulation`.`buy` 
SELECT * 
FROM  `dailymatons_simulation`.`buy_bak`;
...
INSERT INTO  `dailymatons_simulation`.`bet` 
SELECT * 
FROM  `dailymatons_simulation`.`buy_bak`;
