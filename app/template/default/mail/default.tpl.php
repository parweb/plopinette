		...
		<style type="text/css">
			...
			*/
			#templateHeader{
				...
				/*@editable*/ border-bottom:5px solid #f0f;
			}
                                        ...
                                        <tr>
                                            ...
                                            <td class="headerContent" width="100%" style="padding-left:10px; padding-right:20px;">
                                            	<div mc:edit="Header_content">
                                                    <h1><a href="http://dailymatons.com/">Dailymatons.com</a></h1>
                                            	</div>
                                            </td>
                                        </tr>
                                    </table>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" valign="middle" id="social">
                                                            <div mc:edit="std_social">
                                                                <a href="http://dailymatons.com/">Dailymatons.com</a> | <a href="http://dailymatons.com/user/edit/">Votre compte</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
